ActiveAdmin.register Product do
	...
	permit_params :name, :policy_number, :pdf, :description, :policy_type, :company_id, :min_price, :min_date, :min_rate_type, :can_buy_after_30_days,
	...
	controller do
		def clean_params
			params.require(:product).permit(:name, :policy_number, :pdf, :description, :min_price, :min_date, :min_rate_type, :renewable_max_age,
